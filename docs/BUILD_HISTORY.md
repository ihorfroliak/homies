...
| 25 | 2026-07-23 | **TST-01**: OpenAPI realigned — code-generated `docs/api/openapi.json` (35 paths, 39 ops) + pytest drift-guard + exporter; three drifted hand specs retired; CI lints the generated spec | **132** (+1 skipped) | 5 contract tests (drift guard, no-undocumented-route, shape, no-stale-files, core-endpoints); Spectral 0 errors; full suite + lint green | _this cycle_ | — | — |
