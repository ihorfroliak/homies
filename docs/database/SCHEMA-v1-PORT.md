...
| C7b | Viewing settings, weekly and one-off windows in the listing's IANA zone, blackouts, viewings; slots generated by the service and only offered slots bookable; capacity with buffers checked under the settings lock; approval or instant booking | this commit |
| C8 | Files and media | next |
