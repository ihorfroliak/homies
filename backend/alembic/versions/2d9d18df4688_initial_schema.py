...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_domain_events_dedup_key'), 'domain_events', ['dedup_key'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_domain_events_dedup_key'), table_name='domain_events')
